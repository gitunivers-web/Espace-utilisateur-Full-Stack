            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground">Altus Finance Group SAS</p>
                </div>
                <div>
          ...
          <section>
            ...
            <Card>
              <CardContent className="p-6">
                <p className="text-muted-foreground">
                  Le directeur de la publication du site est M. Jean Dupont, Président de la SAS Altus Finance Group.
                </p>
              </CardContent>
            </Card>
          </section>
          ...
          <section>
            ...
            <Card>
              <CardContent className="p-6 space-y-2">
                <p className="text-muted-foreground">
                  Le site www.altusfinance.fr est hébergé par :
                </p>
                <p className="text-muted-foreground">
                  Replit, Inc.<br />
          ...
          <section>
            ...
            <Card>
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Les marques Altus Finance et Altus Finance Group ainsi que les logos figurant sur le site sont des marques déposées.
                </p>
              </CardContent>
            </Card>
          </section>
          ...
          <section>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Toute souscription de crédit est soumise à l'acceptation de votre dossier par Altus Finance Group. 
