          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <ScrollAnimatedElement
                ...
                delay={index * 0.1}
              >
                <Card className="group hover-elevate transition-all duration-300 border-transparent hover:border-primary/20 h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <ScrollAnimatedElement
                ...
                delay={index * 0.15}
              >
                <Card className="relative overflow-visible hover-elevate h-full">
